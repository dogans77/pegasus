...
const copy = {
  ...
  card: "KO\u015eU KARTI", waitEntries: "Yar\u0131\u015f giri\u015fleri geldi\u011finde hesaplan\u0131r", performance: "PERFORMANS", top1: "Top 1 isabet", top3: "ilk 3 kapsama", awaitingResults: "Resmi sonuc bekleniyor",
};
...
export default async function Home() {
  const [races, tracks, performance] = await Promise.all([getJson<Race[]>("/races/", []), getJson<Track[]>("/tracks/", []), getJson<Performance>("/results/performance", { evaluated_races: 0, top1_accuracy: null, top3_coverage: null })]);
