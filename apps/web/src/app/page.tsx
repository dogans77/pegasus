...
export default async function Home(){
 ...
 return <main className="dashboard-shell bright-dashboard">
  <header className="dashboard-nav"><a className="brand" href="/"><span>PEGASUS</span><small>RACE INTELLIGENCE</small></a><nav><a href="#program">Program</a><a href="/decision">Plan</a><a href="/coverage">Kapsam</a><a href="/model">Model</a><a href="/model-research">Ara\u015ft\u0131rma</a><a href="/performance">Performans</a><a href="/data-health">Veri</a></nav><div className="nav-meta"><span>{activeDate||'--'}</span><b className={races.length?'live':'idle'}>{races.length?t.live:t.waiting}</b></div></header>
