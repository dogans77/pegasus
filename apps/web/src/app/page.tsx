...
type Entry = { id?: number; entry_id?: number; program_number: number; barrier?: number | null; weight_kg: number | null; handicap_rating: number | null; agf_percent: number | null; horse_name: string | null; jockey_name?: string | null; score?: number; win_probability?: number };
